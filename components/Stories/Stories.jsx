    ...
    <div className="flex space-x-6 px-6">
      <div>
        <img
          ...
          alt="story"
          className="z-10 hidden h-14 w-14 cursor-pointer rounded-full border-[3px] border-sky-400 object-cover transition-all duration-200 hover:brightness-125 lg:block"
        />
      </div>
      <div>
        <img
          ...
          alt="story"
          className="z-10 h-14 w-14 cursor-pointer rounded-full border-[3px] border-sky-400 object-cover transition-all duration-200 hover:brightness-125 "
        />
      </div>
      <div>
        <img
      ...
      <div>
        <img
          ...
          alt="story"
          className="z-10 h-14 w-14 cursor-pointer rounded-full border-[3px] border-gray-200 object-cover opacity-75 transition-all duration-200 hover:brightness-125"
        />
      </div>
      <div>
        <img
          ...
          alt="story"
          className="z-10 hidden h-14 w-14 cursor-pointer rounded-full border-[3px] border-gray-200 object-cover opacity-75 transition-all duration-200 hover:brightness-125 lg:block"
        />
      </div>
    </div>
  );
